...
@app.route('/savepng', methods=['GET', 'POST'])
def save_aspng():
    if request.method == 'POST':
        # check if the post request has the file part
        if 'file' not in request.files:
    ...
    return '''
    <!doctype html>
    <title>Choose Image to save as png</title>
    <h1>Choose Image to save as png</h1>
    <form method=post enctype=multipart/form-data>
      <input type=file name=file>
      <input type=submit value=Upload>
    </form>
...
@app.route('/savejpg', methods=['GET', 'POST'])
def save_asjpg():
    if request.method == 'POST':
        # check if the post request has the file part
        if 'file' not in request.files:
    ...
    return '''
    <!doctype html>
    <title>Choose Image to save as jpg</title>
    <h1>Choose Image to save as jpg</h1>
    <form method=post enctype=multipart/form-data>
      <input type=file name=file>
      <input type=submit value=Upload>
    </form>
